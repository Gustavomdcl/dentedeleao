...
<head>
	...
	<title>Dente de Leão | Lista de Email</title>

	<!-- SEO rel="nofollow" on links
	======================================================== -->
	<meta name="robots" content="NOINDEX, nofollow" />	
	<meta name="title" content="Dente de Leão | Lista de Email">
			...
			<div class="l-container cf">
				...
				<div class="l-row">
					...
					<div class="l-col12">
						...
						<h1>Lista de Email <i class="fa fa-envelope"></i></h1>
		...
		<section class="l-new">
			...
			<div class="l-container cf">
				...
				<div class="l-row">
					...
					<form id="formEmailList" method="post" action="backend/envios/enviarEmailList.php">
						...
						<div class="content">
							...
							<nav>
								<ul class="l-row">
									...
									$sqlEmailList = "SELECT * FROM DL_ADMIN_emailList order by id desc";

									$resultEmailList = mysql_query($sqlEmailList);

								   	while ($row=mysql_fetch_array($resultEmailList)) {
								   		$id=$row['id'];
										$email=$row['email'];
