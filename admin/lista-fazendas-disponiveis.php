...
<head>
	...
	<title>Dente de Leão | Lista de Fazendas Disponíveis</title>

	<!-- SEO rel="nofollow" on links
	======================================================== -->
	<meta name="robots" content="NOINDEX, nofollow" />	
	<meta name="title" content="Dente de Leão | Lista de Fazendas Disponíveis">
			...
			<div class="l-container cf">
				...
				<div class="l-row">
					...
					<div class="l-col12">
						...
						<ul class="nav">
							...
							<li>Lista de Fazendas Disponíveis</li>
						</ul>
				...
				<div class="l-row">
					...
					<div class="l-col12">
						...
						<h1>Lista de Fazendas Disponíveis <i class="fa fa-map-marker"></i></h1>
